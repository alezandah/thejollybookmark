...
2. Then run "bundle install" from the project directory 
3. Run "bundle exec rake db:migrate" or "rake db migrate" 
4. Start your server using "rails server" 
5. Navigate to "localhost:3000" and interact with the app
