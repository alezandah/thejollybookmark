...
1. The Index page contains a button with a link to view the current user’s profile
...
i. First, clone this repository locally
ii. Then run "bundle install" from the project directory
iii. Run "bundle exec rake db:migrate" or "rake db migrate"
iv. Start your server using "rails server"
v. Navigate to "localhost:3000" and interact with the app
